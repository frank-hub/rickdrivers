            ...
            <div class="col-xl-5 col-xxl-4">
                <div class="login-form-area">
                    ...
                    <form class="login-form" method="POST" action="{{ route('login') }}">
                        ...
                        <input type="password" placeholder="Enter your email" class="w-100 rounded @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        ...
                        <p class="text-xl-center mt-4">Don't have an account? <a href="{{route('register')}}">Sign Up</a></p>
                    </form>
                </div>
            </div>
