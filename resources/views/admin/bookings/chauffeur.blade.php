          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Chauffeur Book Listing <small>Table</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Chauffeur Booking Tables</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      s_instructions --}}
                      <tbody>
                        @foreach ($chauffeurBooking as $booking)
                            <tr>
                                <td>{{$booking->id}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('chauffeurbook_show',$booking->id)}}">
