              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Car Rentals <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form_validation.html">Create</a></li>
                      <li><a href="tables_dynamic.html">Listing</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-table"></i> Hotel Bookings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form_validation.html">Create</a></li>
                      <li><a href="tables_dynamic.html">Listing</a></li>
                    </ul>
